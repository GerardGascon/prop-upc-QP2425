...
public class CatalanAI extends AI {
    /**
     * Constructor per a la implementació d'IA en català.
     * <p>
     * Inicialitza els components necessaris perquè la IA pugui calcular moviments
     * vàlids en partides amb l'idioma català, incloent el tractament especial
     * per a les lletres específiques del català com 'NY' i 'L·L'.
